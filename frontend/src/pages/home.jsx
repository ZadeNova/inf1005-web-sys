    ...
    <div className="min-h-screen bg-(--color-bg) flex flex-col">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 flex flex-col items-center text-center gap-6">
        ...
        <div className="flex gap-3">
          <a href="/listings" className="px-6 py-3 rounded-md bg-(--color-accent) text-white font-semibold text-sm hover:bg-(--color-accent-hover) transition-colors">
            Browse Market
          </a>
          <a href="/register" className="px-6 py-3 rounded-md border border-(--color-border) text-(--color-text-primary) font-semibold text-sm hover:border-(--color-accent) hover:text-(--color-accent) transition-colors">
            Create Account
          </a>
        </div>
      </section>
