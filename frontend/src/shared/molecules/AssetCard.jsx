...
export default function AssetCard({
	...
	const { id, name, rarity, condition, collection, imageUrl, price, seller } =
		asset;
	...
	return (
		<a
			href={`/listings/${id}`}
			className="block rounded-lg focus-visible:outline-2 focus-visible:outline-(--color-accent) focus-visible:outline-offset-2"
		>
			<Card
				variant="default"
				padding={compact ? "sm" : "md"}
				glow
				className="flex flex-col gap-3 hover:border-(--color-accent) transition-colors cursor-pointer"
			>
				{/* Asset image */}
