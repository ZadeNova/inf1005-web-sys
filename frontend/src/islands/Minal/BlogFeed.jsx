...
const MOCK_POSTS = [
  {
    ...
    excerpt: 'A breakdown of the rarity distribution, price floors, and top performers from the latest Shadowfall drop.',
    author: '0xVault',
  ...
  },
  {
    ...
    excerpt: 'Atomic transactions explained — from making an offer to acceptance and settlement.',
    author: 'ShadowHawk',
  ...
  },
  {
    ...
    excerpt: 'Why colour alone is never enough — how Vapour FT uses symbols alongside colour for rarity indicators.',
    author: 'VaultKeeper',
  ...
  },
  {
    ...
    excerpt: 'The Celestial Series introduces three new Secret Rare pieces. We break down pull rates and estimated floor prices.',
    author: 'DropWatch',
  ...
  },
  {
    ...
    excerpt: 'Common, Uncommon, Rare, Ultra Rare, Secret Rare — what do they actually mean for value and trading strategy?',
    author: '0xVault',
  ...
  },
  {
    ...
    excerpt: 'We revisit the inaugural Core Drop and track how asset prices have moved since launch. Some surprises inside.',
    author: 'VaultKeeper',
  ...
  },
  {
    ...
    excerpt: 'An interview with the generative art process — how algorithms and hand-drawn elements combine to create unique pieces.',
    author: 'ShadowHawk',
  ...
  },
  {
    ...
    excerpt: 'Promo and Tournament Exclusive assets have different rarity rules. Here\'s how the system works.',
    author: 'DropWatch',
...
export default function BlogFeed() {
  ...
  return (
    <section aria-labelledby="blog-feed-heading">
      <h2 id="blog-feed-heading" className="sr-only">Blog Posts</h2>
